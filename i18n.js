...
const I18N = {
  'zh-CN': {
    ...
    review_sub: '道混合咒语测验',
    share_btn: '📤 生成分享卡片',
    share_hint: '截图保存，分享给朋友',
    share_close: '关闭',
    share_progress: '已习得咒语',
    share_quiz: '答题成绩',
    all_learned_btn: '✦ 重新测验',
    start_quiz_btn: '⚡ 开始魔法测验',
    learned_badge: '已习得',
    locked_label: '即将开放',
    gh_connect: '🐱 连接 GitHub 云端保存进度',
    gh_connected: '✓ 已连接 GitHub',
    gh_sync: '同步',
    gh_restore: '恢复',
    gh_disconnect: '断开',
    gh_syncing: '同步中…',
    gh_sync_ok: '✓ 进度已同步到 GitHub',
    gh_restore_ok: '✓ 进度已从 GitHub 恢复',
    gh_expire: 'GitHub 授权已过期，请重新连接',
    gh_no_backup: '未找到备份，请先同步一次',
    gh_not_configured: '请先完成 GitHub OAuth 配置',
  },
  'zh-TW': {
    site_name: 'AI魔法詞典',
    ...
    review_sub: '道混合咒語測驗',
    share_btn: '📤 生成分享卡片',
    share_hint: '截圖保存，分享給朋友',
    share_close: '關閉',
    share_progress: '已習得咒語',
    share_quiz: '答題成績',
    all_learned_btn: '✦ 重新測驗',
    start_quiz_btn: '⚡ 開始魔法測驗',
    learned_badge: '已習得',
    locked_label: '即將開放',
    gh_connect: '🐱 連接 GitHub 雲端保存進度',
    gh_connected: '✓ 已連接 GitHub',
    gh_sync: '同步',
    gh_restore: '恢復',
    gh_disconnect: '斷開',
    gh_syncing: '同步中…',
    gh_sync_ok: '✓ 進度已同步到 GitHub',
    gh_restore_ok: '✓ 進度已從 GitHub 恢復',
    gh_expire: 'GitHub 授權已過期，請重新連接',
    gh_no_backup: '未找到備份，請先同步一次',
    gh_not_configured: '請先完成 GitHub OAuth 配置',
  }
};
